...
DATABASE_URL = os.environ.get("DATABASE_URL", "")  # Add your own atlas db mongodb+srv://itsgoluAPI:jrMHSipToKUEnmcp@cpprivateapi.ghhp3oz.mongodb.net/?appName=CpprivateApi
